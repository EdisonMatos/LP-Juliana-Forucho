...
export const infos = {
  ...
  phone: {
    ddd: '67',
    firstPart: '99277', // Apenas os 5 primeiros números (incluindo o 9)
    secondPart: '7614', // Apenas os 4 últimos números
  },
  phoneSecundario: {
    ddd: 'A_Definir',
...
const content = {
  texts: {
    ...
    about: {
      ...
      subtitle:
        'Transformando indignação em justiça pela saúde de pessoas autistas',
